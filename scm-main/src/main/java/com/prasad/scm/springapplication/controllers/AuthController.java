...
public class AuthController {
    ...
    public ResponseEntity<?> authenticateUser(@Valid @RequestBody LoginRequest loginRequest) {
        try {
            ...
            return ResponseEntity.status(HttpStatus.OK).body(new JwtResponse(jwt, userDetails.getId(),
    ...
    public ResponseEntity<ForgotPasswordResponse> forgotPassword(@RequestParam(required = false) String email) {
        ...
        // Here I am comparing if the email is valid or invalid
     ...
     * @return ResponseEntity containing a success message if the password is reset successfully, or an error message if the token or password is invalid
     */
    ...
    public ResponseEntity<ForgotPasswordRequest> resetPassword(@RequestParam(required = false) String token,
        ...
        // Encrypting the changed password
