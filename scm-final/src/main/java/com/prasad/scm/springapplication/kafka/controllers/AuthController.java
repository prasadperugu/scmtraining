...
//    MailController mailcontroller;
    ...
    public ResponseEntity<ForgotPasswordResponse> forgotPassword(@RequestParam(required = false) String email) {
        ...
        // Here I am cmapre the email is valid or invalid
        if (response.equals("Invalid email id.")) {
            ...
            try {
                ...
                // retuns the error as BAD_REQUEST message with status code 400
                return new ResponseEntity(HttpStatus.BAD_REQUEST);
            }
            System.out.println(response);
            // retuns the success message with status code 200
